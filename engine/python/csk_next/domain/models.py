...
TASK_TRANSITIONS: dict[str, set[str]] = {
    ...
    "frozen": {"plan_approved", "critic_passed"},
    "plan_approved": {"executing", "critic_passed"},
    "executing": {"ready_validated", "blocked", "critic_passed"},
    "ready_validated": {"ready_approved", "critic_passed", "blocked"},
    "ready_approved": {"ready_validated", "retro_done"},
    "blocked": {"retro_done"},
    "retro_done": {"closed"},
    "closed": set(),
}
