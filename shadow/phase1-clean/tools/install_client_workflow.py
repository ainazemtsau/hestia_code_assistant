...
def _load_install_lib():
    ...
    spec = importlib.util.spec_from_file_location("shadow_phase1_install_lib", module_path)
...
def main() -> int:
    ...
    print(
        f"[csk-install] project_root={summary['project_root']} "
        f"assets={len(summary['installed_assets'])}"
    )
