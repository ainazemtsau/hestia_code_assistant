...
def _load_install_lib():
    ...
    spec = importlib.util.spec_from_file_location("csk_phase1_install_lib_update", module_path)
...
def main() -> int:
    ...
    print(f"[csk-update] project_root={summary['project_root']} assets={len(summary['updated_assets'])}")
